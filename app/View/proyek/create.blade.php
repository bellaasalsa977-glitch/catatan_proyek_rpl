                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('proyek.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama_proyek" id="nama_proyek" value="{{ old('nama_proyek') }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            ...
                            <div>
                                <label for="teknologi" class="block text-sm font-medium text-gray-700">Teknologi (Contoh: Laravel, MySQL, C#)</label>
                                <input type="text" name="teknologi" id="teknologi" value="{{ old('teknologi') }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                            ...
                            <div>
                                ...
                                <input type="date" name="tanggal_mulai" id="tanggal_mulai" value="{{ old('tanggal_mulai') }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            ...
                            <div>
                                ...
                                <input type="date" name="tanggal_selesai" id="tanggal_selesai" value="{{ old('tanggal_selesai') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
